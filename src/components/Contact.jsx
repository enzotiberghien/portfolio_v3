  ...
  return (
    <div className='space-y-12' id='contact'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12'>
        ...
        <div><a className='flex items-center space-x-4' href="https://github.com/enzotiberghien"><img className='w-6 md:w-8' src={github} alt="" /> <div>/enzotiberghien</div></a></div>
        <div><a className='flex items-center space-x-4' href="https://linkedin.com/in/enzo-tiberghien"><img className='w-6 md:w-8' src={linkedin} alt="" /> <div>/enzo-tiberghien</div></a></div>
      </div>
    </div>
  )
}
